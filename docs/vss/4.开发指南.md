...
- **流媒体服务**：下载对应系统的流媒体二进制文件 [https://github.com/yyyirl/go-vss/releases/tag/V1.0.6](https://github.com/yyyirl/go-vss/releases/tag/V1.0.6)
...
- 视频管理平台（网页）
  项目地址 [https://github.com/yyyirl/skeyevss_frontend_web](https://github.com/yyyirl/skeyevss_frontend_web)
    - 启动 `cd skeyevss_frontend_web && yarn && yarn start`
    - 默认端口为 **4000**，通过env修改

- app

  项目地址 [https://github.com/yyyirl/skeyevss_frontend_app](https://github.com/yyyirl/skeyevss_frontend_app)
