...
type MsRowLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewMsRowLogic(ctx context.Context, svcCtx *svc.ServiceContext) *MsRowLogic {
	return &MsRowLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *MsRowLogic) MsRow(in *db.IDReq) (*db.Response, error) {
	row, err := l.svcCtx.MediaServersModel.Row(in.ID)
	if err != nil {
