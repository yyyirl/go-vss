...
func UpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var ctx = r.Context()
		if err := permissions.New(ctx).Authentication(contextx.GetSuperState(ctx), permissions.P_0_2_1_2, contextx.GetPermissionIds(ctx)); err != nil {
		...
		if err := dictionaries.NewUpdateLogic(ctx, svcCtx).Update(&req); err != nil {
