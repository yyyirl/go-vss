...
func DeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var ctx = r.Context()
		if err := permissions.New(ctx).Authentication(contextx.GetSuperState(ctx), permissions.P_0_1_3_5, contextx.GetPermissionIds(ctx)); err != nil {
		...
		if err := departments.NewDeleteLogic(ctx, svcCtx).Delete(&req); err != nil {
