...
import (
	...
	"skeyevss/core/app/sev/backend/internal/logic/device/alarms"
...
func DeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var ctx = r.Context()
		if err := permissions.New(ctx).Authentication(contextx.GetSuperState(ctx), permissions.P_0_6_4_1, contextx.GetPermissionIds(ctx)); err != nil {
		...
		if err := alarms.NewDeleteLogic(ctx, svcCtx).Delete(&req); err != nil {
