...
import (
	...
	"skeyevss/core/app/sev/backend/internal/logic/device/channels"
...
func UpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var ctx = r.Context()
		if err := permissions.New(ctx).Authentication(contextx.GetSuperState(ctx), permissions.P_0_3_2_2, contextx.GetPermissionIds(ctx)); err != nil {
		...
		if err := channels.NewUpdateLogic(ctx, svcCtx).Update(&req); err != nil {
