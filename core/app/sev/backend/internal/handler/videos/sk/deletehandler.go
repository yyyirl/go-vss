...
func DeleteHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var ctx = r.Context()
		if err := permissions.New(ctx).Authentication(contextx.GetSuperState(ctx), permissions.P_0_4_2_5, contextx.GetPermissionIds(ctx)); err != nil {
		...
		if err := sk.NewDeleteLogic(ctx, svcCtx).Delete(&req); err != nil {
